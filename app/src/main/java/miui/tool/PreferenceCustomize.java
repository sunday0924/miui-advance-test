...
public class PreferenceCustomize extends PreferenceFragment implements OnPreferenceChangeListener {
	...
	public void onCreate(Bundle arg0) {
		...
		mDpi.setSummary("��ȡ����ֵ��"+defaultDpi+"��Ĭ��ֵ��480.");
	...
	public void chooseReport(){
		...
		Builder mDialogBuilder = new Builder(getActivity());
	...
	public boolean onPreferenceChange(Preference preference, Object newValue) {
		...
		if (preference == mDpi) {
			...
			if (!TextUtils.isEmpty(valueString)) {
				...
				//	Toast.makeText(getActivity().getApplicationContext(), "�����ֵС��300�����600!", 1).show();
					return false;
				}else {
					Utils.runCmd("setprop persist.jldensity " + valueString);
					mDpi.setSummary("�������ֵ��"+valueString+", Ĭ��Ϊ480.");
					DialogShow(getActivity());
					return true;
				}
			}else {
			//	Toast.makeText(getActivity().getApplicationContext(), "�����ֵ����Ϊ��!", 1).show();
				return false;
			}
		}
		if (preference == mSwitchCamera) {
			...
			if (index == 0) {
				...
				if (!flag) {
		//			Toast.makeText(getActivity().getApplicationContext(), "�����л�..���Ժ�һ��", 0).show();
		...
		//	Toast.makeText(getActivity().getApplicationContext(), "�л������ɣ������ڿ���ʹ���ˡ�", 0).show();
			return true;
		}
		return false;
	}
	...
	public static void DialogShow(Context context,String msg){
		Builder mDialogBuilder = new Builder(context);
		if (msg.equals("1")) {
			mDialogBuilder.setMessage("��������������������Ч����!");
		}else {
			mDialogBuilder.setMessage(msg);
		}
		mDialogBuilder.setCancelable(false);
		mDialogBuilder.setPositiveButton("ȷ������", new OnClickListener() {
